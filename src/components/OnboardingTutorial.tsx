...
import { X, ChevronRight, ChevronLeft, CheckCircle2, Sparkles, Shield, MessageSquare } from 'lucide-react';
  ...
  const steps: Step[] = [
    {
      ...
      description: "This is your secure command center for all legal matters with OROELU GODWIN AGIDI & CO. Let's take a quick tour.",
      icon: Sparkles,
      color: "text-gold"
    },
    {
      title: "Track Your Cases",
      description: "Monitor the progress of your legal matters in real-time. See milestones, next steps, and lead attorneys for each case.",
      icon: Shield,
      color: "text-blue-600"
    },
    {
      title: "Secure Communication",
      description: "Message your legal team directly through our encrypted channel. Get updates and ask questions anytime.",
      icon: MessageSquare,
      color: "text-navy"
    },
    {
      title: "AI-Powered Insights",
      description: "Our advanced AI analyzes your profile to provide strategic recommendations and risk alerts tailored to your business.",
      icon: CheckCircle2,
