...
const services = [
  {
    ...
    description: 'Representation at the High/Appellate Courts and Tribunals.',
    features: [
      'Appellate cases',
      'General civil cases',
      'Divorce cases',
  ...
  },
  {
    ...
    features: [
      ...
      'Land documentation',
      'Will writing',
      'Will writing, administration of estate',
      'Documentation',
      'Due diligence investigation and Compliance services',
    ],
      'Due diligence investigation and Compliance services',
    ],
    highlighted: false,
